...
public class ExpJjsjzx  {
	...
	private int cb_num;  
	private String exp_cl_sts ;
	private String opt_name;
	private String cl_smp;
	
	public String getExp_cl_sts() {
		return exp_cl_sts;
	}

	public void setExp_cl_sts(String exp_cl_sts) {
		this.exp_cl_sts = exp_cl_sts;
	}
	...
	public String toString() {
		return "ExpJjsjzx [jj_id=" + jj_id + ", sj_id=" + sj_id + ", sj_type="
				+ sj_type + ", sj_title=" + sj_title + ", tm_smp=" + tm_smp
				+ ", cb_num=" + cb_num + ", exp_cl_sts=" + exp_cl_sts
